    ...
    setCurrent(num){
        this.setState({
            currentPage: num 
                ...
                const currentPosts = this.state.loadedItems.slice(indexOfFirstPost, indexOfLastPost);
                this.setState({
            ...
            <React.Fragment>
                <section className="mt-5">
                    ...
                    <div>
                            ...
                            <Pagination postsPerPage={this.state.postsPerPage} totalPosts={this.state.loadedItems.length} paginate={(num) => this.setCurrent(num)} currentPage={this.state.currentPage}/>
                    </div>
